  ...
  return (
    <div className="grid grid-cols-3 gap-6 mt-6">
      {imageList?.map((image, index) => {
        return (
          <div key={index} className="p-2 group overflow-hidden relative rounded-md w-[280px] h-[280px] relative transition hover:transform hover:scale-105 bg-white shadow-md hover:shadow-lg">
